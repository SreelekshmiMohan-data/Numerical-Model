...
def combined_j_nu_b(s,vprime,y,s2_vprime_out,theta_vprime_out,NU,w0_out,free_parms):
	...
	j_nu_synch = nonthermal_functions.j_nu2(s,vprime,theta_vprime_out,y,s2_vprime_out,w0_out,free_parms,NU)
...
def combined_alpha_nu_b(s,vprime,y,s2_vprime_out,theta_vprime_out,NU,w0_out,free_parms):
	...
	alpha_nu_synch = nonthermal_functions.alpha_nu2(s,vprime,theta_vprime_out,y,s2_vprime_out,w0_out,free_parms,NU)
...
def combined_j_nu_f(s,vprime,y,s1_vprime_out,theta_vprime_out,NU,w0_out,free_parms):
	...
	j_nu_synch = nonthermal_functions.j_nu1(s,vprime,theta_vprime_out,y,s1_vprime_out,w0_out,free_parms,NU)
...
def combined_alpha_nu_f(s,vprime,y,s1_vprime_out,theta_vprime_out,NU,w0_out,free_parms):
	...
	alpha_nu_synch = nonthermal_functions.alpha_nu1(s,vprime,theta_vprime_out,y,s1_vprime_out,w0_out,free_parms,NU)
