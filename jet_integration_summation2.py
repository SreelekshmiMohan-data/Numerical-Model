...
def ff1(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms):
		...
		tau_ff_inner = jet_parts_summation2.free_tau_inner1(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms,s1_vprime_in,s1_vprime_out,s2_vprime_in,s2_vprime_out,theta_vprime_in,theta_vprime_out)
		f_ff_inner = jet_parts_summation2.free_inner1(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms,s1_vprime_in,s1_vprime_out,s2_vprime_in,s2_vprime_out,theta_vprime_in,theta_vprime_out)

		f_behind = jet_parts_summation2.flux_b(vprime,y,s2_vprime_out,theta_vprime_out,NU,w0_out,free_parms,lower2,upper2)
		tau_front = jet_parts_summation2.sigma_tau_f(upper1,vprime,y,s1_vprime_out,theta_vprime_out,NU,w0_out,free_parms,lower1,upper1,divisions)
		f_front = jet_parts_summation2.flux_f(vprime,y,s1_vprime_out,theta_vprime_out,NU,w0_out,free_parms,lower1,upper1)
...
def ff2(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms):
		...
		tau_ff_inner = jet_parts_summation2.free_tau_inner2(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms,WE_in,WE_out,GH_in,GH_out,s1_vprime_in,s1_vprime_out,s2_vprime_in,s2_vprime_out,theta_vprime_in,theta_vprime_out)
		f_ff_inner = jet_parts_summation2.free_inner2(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms,WE_in,WE_out,GH_in,GH_out,s1_vprime_in,s1_vprime_out,s2_vprime_in,s2_vprime_out,theta_vprime_in,theta_vprime_out)
...
def ff3(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms):
		...
		tau_ff_inner = jet_parts_summation2.free_tau_inner3(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms,WE_in,WE_out,GH_in,GH_out,s1_vprime_in,s1_vprime_out,s2_vprime_in,s2_vprime_out,theta_vprime_in,theta_vprime_out)
		f_ff_inner = jet_parts_summation2.free_inner3(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms,WE_in,WE_out,GH_in,GH_out,s1_vprime_in,s1_vprime_out,s2_vprime_in,s2_vprime_out,theta_vprime_in,theta_vprime_out)

		f_behind = jet_parts_summation2.flux_b(vprime,y,s2_vprime_out,theta_vprime_out,NU,w0_out,free_parms,lower2,upper2)
		tau_front1 = jet_parts_summation2.sigma_tau_f(upper1,vprime,y,s1_vprime_out,theta_vprime_out,NU,w0_out,free_parms,lower1,upper1,divisions)
		f_front1 = jet_parts_summation2.flux_f(vprime,y,s1_vprime_out,theta_vprime_out,NU,w0_out,free_parms,lower1,upper1)
		tau_front2 = jet_parts_summation2.sigma_tau_b(upper3,vprime,y,s2_vprime_out,theta_vprime_out,NU,w0_out,free_parms,lower3,upper3,divisions)
		f_front2 = jet_parts_summation2.flux_b(vprime,y,s2_vprime_out,theta_vprime_out,NU,w0_out,free_parms,lower3,upper3)
...
def ff4(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms):
		...
		tau_ff_inner = jet_parts_summation2.free_tau_inner4(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms,GH_in,GH_out,s1_vprime_in,s1_vprime_out,s2_vprime_in,s2_vprime_out,theta_vprime_in,theta_vprime_out)
		f_ff_inner = jet_parts_summation2.free_inner4(vprime,y,theta_in,theta_out,w0_in,w0_out,ybmax_in,ybmax_out,NU,free_parms,GH_in,GH_out,s1_vprime_in,s1_vprime_out,s2_vprime_in,s2_vprime_out,theta_vprime_in,theta_vprime_out)
